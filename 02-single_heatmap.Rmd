...
```{r, fig.width = 14, fig.height = 14/5, echo = FALSE, message = FALSE, out.width = "100%"}
...
```{r cluster_dendsort, fig.width = 10, fig.height = 5, echo = FALSE, out.width = "100%"}
m2 = matrix(1:100, nr = 10, byrow = TRUE)
pushViewport(viewport(x = 0, width = 0.5, just = "left"))
...
```{r, fig.width = 5.2, fig.height = 5.2}
Heatmap(mat, name = "mat",
...
```{r, fig.show = "hold", echo = FALSE, fig.width = 1.6*4, fig.height = 1.6, out.width = "100%", fig.align = "left"}
