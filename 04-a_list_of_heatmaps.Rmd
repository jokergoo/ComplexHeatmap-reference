...
```{r heatmap_list_title, fig.width = 9}
...
```{r heatmap_list_size, fig.width = 9, fig.keep = "all"}
...
```{r heatmap_list_relative_size, fig.width = 9}
...
```{r heatmap_list_gap, fig.width = 9}
ht1 = Heatmap(mat1, name = "rnorm", col = col_rnorm)
ht2 = Heatmap(mat2, name = "runif", col = col_runif)
ht3 = Heatmap(le, name = "letters", col = col_letters)
ht_list = ht1 + ht2 + ht3
...
```{r heatmap_list_auto_adjust, fig.width = 9, fig.keep = "all"}
...
```{r heatmap_list_auto_adjust_no_row_cluster, fig.width = 9}
